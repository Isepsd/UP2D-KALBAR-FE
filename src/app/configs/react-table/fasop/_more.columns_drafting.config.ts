...
export const NO = () => [{ Header: 'No', accessor: 'number', minWidth: '50px', pinned: true, stickyLeft: 30,disableSortBy: true, disableFilters: true, show: true, fixed: true }]
export const ACTION_COLUMN = () => [{ Header: 'Aksi', accessor: 'action', minWidth: '20px',pinned: true, stickyLeft: 70, disableSortBy: true,maxWidth: '20px', canFilter: false, show: true, hideColumn: false , disableFilters: true,}];
