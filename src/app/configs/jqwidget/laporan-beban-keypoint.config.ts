import { BEBAN_PERJAM_JQWIDGET, DATETIME_JQWidget, LOADfAKTOR_JQWidget, GARDU_INDUK_PENYULANG_JQWidget, MONTH_YEAR_JQWidget, NO_JQWidget, KEYPOINT_JQWidget, ULP_JQWidget, UP3_JQWidget, YEAR_JQWidget } from "./_more-jqwidget.column.config"
import { DATETIME_DATAFIELD_JQWidget, NO_DATAFIELD_JQWidget, TRAFO_DATAFIELD_JQWidget, GARDU_INDUK_PENYULANG_DATAFIELD_JQWidget, } from "./_more-jqwidget.datafield.config"
...
export const BEBAN_KEYPOINT_PERJAM_COLUMN_JQWIDGET = () => {
    return {
        columns: [
            ...NO_JQWidget(),
            ...DATETIME_JQWidget(),
            ...GARDU_INDUK_PENYULANG_JQWidget(),
            ...KEYPOINT_JQWidget(),
            ...UP3_JQWidget(),
            ...ULP_JQWidget(),
        ...
        dataField: [
            ...
            ...GARDU_INDUK_PENYULANG_DATAFIELD_JQWidget(),
