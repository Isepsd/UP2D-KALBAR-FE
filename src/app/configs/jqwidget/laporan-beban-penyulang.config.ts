import { BEBAN_PERJAM_JQWIDGET, DATETIME_JQWidget, GARDU_INDUK_JQWidget, LOADfAKTOR_JQWidget, MONTH_YEAR_JQWidget, NO_JQWidget, PENYULANG_JQWidget, ULP_JQWidget, UP3_JQWidget, YEAR_JQWidget } from "./_more-jqwidget.column.config"
