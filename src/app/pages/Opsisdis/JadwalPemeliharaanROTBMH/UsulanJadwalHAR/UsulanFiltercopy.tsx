...
export default function UsulanFilter() {
  ...
  const status_pekerjaan = [
    ...
    { label: "RELEASE PEKERJAAN", value: "RELEASE PEKERJAAN" },
  ];
  ...
  //   extraFilter = { approvel_area: 0, approvel_apd: 0, release_rotbmh: 0 };
  // }

  // if (data.status_approval === "POSTING") {
  //   extraFilter = { approvel_area: 1, approvel_apd: 0, release_rotbmh: 0 };
  // }

  if (data.status_approval === "SETUJU") {
    extraFilter = { approvel_area: 1, approvel_apd: 1, release_rotbmh: 0 };
  }
