...
function ApproveJadwalHarUidDetailFormPageCopy({ trans_jadwal_har_id, handleClose, approvel_uid }: IFormUploadDocument) {
  ...
  return (
    <>
      ...
      {isAllreadyId.trans_jadwal_har_id && approvel_uid === 1 && (
...
export default ApproveJadwalHarUidDetailFormPageCopy