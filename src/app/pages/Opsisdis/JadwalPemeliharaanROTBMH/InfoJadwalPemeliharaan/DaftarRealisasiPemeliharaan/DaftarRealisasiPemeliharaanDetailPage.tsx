...
import DaftarRealisasiPemeliharaanDetailForm from "./DaftarRealisasiPemeliharaanDetailForm"
...
export default function DaftarRealisasiPemeliharaanDetailPage({ filterParams }: any) {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("daftar-realisasi-har");
        const roleAct = {
            ...
            {roleActions.view && roleActions.create && roleActions.updatedok && roleActions.updategar && roleActions.delete ? (
                <>
                    ...
                    <ModalFormWO modalProps={{ ...modalUpload, setShow: handleClose }}>
                        <DaftarRealisasiPemeliharaanDetailForm
