...
function DaftarRealisasiPemeliharaanDetailForm({ trans_jadwal_har_id, handleClose }: IFormUploadDocument) {
...
export default DaftarRealisasiPemeliharaanDetailForm