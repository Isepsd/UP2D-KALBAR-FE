...
import DaftarBatalJadwalHarDetailFormPage from "./DaftarBatalJadwalHarDetailFormPage"
...
export default function DaftarBatalPemeliharaanDetailPage({ filterParams }: any) {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("daftar-batal-har");
        const roleAct = {
            ...
            {roleActions.view && roleActions.create && roleActions.updatedok && roleActions.updategar && roleActions.delete ? (
                <>
                    ...
                    <ModalFormWO modalProps={{ ...modalUpload, setShow: handleClose }}>
                        <DaftarBatalJadwalHarDetailFormPage
