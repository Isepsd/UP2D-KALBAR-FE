...
import DaftarManuverPemeliharaanDetailForm from "./DaftarManuverPemeliharaanDetailForm"
...
export default function DaftarManuverPemeliharaanDetailPage({ filterParams }: any) {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("daftar-manuver-har");
        const roleAct = {
            ...
            {roleActions.view && roleActions.create && roleActions.updatedok && roleActions.updategar && roleActions.delete ? (
                <>
                    ...
                    <ModalFormWO modalProps={{ ...modalUpload, setShow: handleClose }}>
                        <DaftarManuverPemeliharaanDetailForm
