...
import DaftarRencanaPemeliharaanDetailForm from "./DaftarRencanaPemeliharaanDetailForm"
...
export default function DaftarRencanaPemeliharaanDetailPage({ filterParams }: any) {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("daftar-rencana-har");
        const roleAct = {
            ...
            {roleActions.view && roleActions.create && roleActions.updatedok && roleActions.updategar && roleActions.delete ? (
                <>
                    ...
                    <ModalFormWO modalProps={{ ...modalUpload, setShow: handleClose }}>
                        <DaftarRencanaPemeliharaanDetailForm
