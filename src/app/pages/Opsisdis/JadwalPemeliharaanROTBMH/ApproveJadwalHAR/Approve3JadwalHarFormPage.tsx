...
function ApproveJadwalHarFormPage({
  ...
  const onSubmitForm = async (data: IJadwalPemerliharaan) => {
    ...
    const params = {
      ...
      approvel_3: approvelApd, // Tambahkan approvel_apd dengan nilai 1
  ...
  return (
    <>
      {isAlreadyPosting3 === 1 ? (
        ...
        <Alert variant="warning" className="text-center mb-4">
          <p>Data Harus di approve 2 dulu</p>
        </Alert>
      ) :isAlreadyPosting2 === '' ? (
        <Alert variant="warning" className="text-center mb-4">
          <p>Data Harus di approve 2 dulu</p>
        </Alert>
      ) :isAlreadyPosting2 === null ? (
        <Alert variant="warning" className="text-center mb-4">
          <p>Data Harus di approve 2 dulu</p>
        </Alert>
      ): isAlreadyPosting2 === 2 ? (
        ...
        isAlreadyApproved === 1 && isAlreadyPosting2 === 1 && (isAlreadyPosting3 === 0 || isAlreadyPosting3 === null || isAlreadyPosting3 === '') && (
          <FormData
            setError={setError}
            setValue={setValue}
