...
function ApproveJadwalHarDetailFormPageCopy({ trans_jadwal_har_id, handleClose, approvel_apd }: IFormUploadDocument) {
  ...
  return (
    <>
      ...
      {isAllreadyId.trans_jadwal_har_id && approvel_apd === 1 && (
...
export default ApproveJadwalHarDetailFormPageCopy