...
function UsulanJadwalHarFormPage({
  ...
  const validationSchema = Yup.object().shape({
    ...
    n_1_terpenuhi: Yup.string()
      .nullable()
      .transform((_, v) => (v == "1" ? "1" : "0")),
    n_1_1_terpenuhi: Yup.string()
    .nullable()
    .transform((_, v) => (v == "1" ? "1" : "0")),
    // n_1_1_terpenuhi_ket: Yup.string().nullable(),
    // n_1_terpenuhi_ket: Yup.string().nullable(),
...
///////////////////////////////////CEKLIS YANTEK VENDOR
  ...
  const onSubmitForm = (data: IJadwalPemerliharaan) => {
    ...
    if (data.n_1_terpenuhi === 0) {
      filledData.n_1_terpenuhi_ket = "";
    }

    if (data.n_1_1_terpenuhi === 0) {
      filledData.n_1_1_terpenuhi_ket = "";
    }
  ...
  return (
    ...
    //           <p>Data yang sudah di Ceklis tidak bisa di Ceklis kembali</p>
    //         </Alert>
    // ) : 
    !isUID ? (
            <Alert variant="warning" className="text-center mb-4">
              <p>Sifat Pekerjaan 2 dan 5 harus approve UID dulu</p>
            </Alert>
    ) : (isUID && (isAlreadyCeklis === 0 || isAlreadyCeklis === null || isAlreadyCeklis === 1)) && (
          ...
          <Row>
            <Col md={6}>
              ...
              <FormInputControlColumnNew
                ...
                isInvalid={!!errors?.n_1_terpenuhi_ket || isKeteranganOverLimit}
                message={
                  errors?.n_1_terpenuhi_ket?.message ||
                ...
                rows="4"
                onChange={(e) =>
                  handleInputChange("n_1_terpenuhi_ket", e.target.value)
                }
              />
            ...
            <Col md={6}>
              ...
              {/* <Form.Group as={Row} className="mb-3">
                ...
                <Col md={8}>
                  <Form.Control
                    ...
                    isInvalid={
                      !!errors?.sifat_pekerjaan || isSifatPekerjaanOverLimit
                    }
                    onChange={(e) =>
                      handleInputChange("sifat_pekerjaan", e.target.value)
                    }
                  />
                  {(errors?.sifat_pekerjaan || isSifatPekerjaanOverLimit) && (
                    <Form.Control.Feedback type="invalid">
                      {errors?.sifat_pekerjaan?.message ||
                        "Karakter tidak boleh lebih dari 250."}
                    </Form.Control.Feedback>
                  )}
                </Col>
              ...
              <FormInputControlColumnNew
                ...
                isInvalid={!!errors?.n_1_1_terpenuhi_ket || isKeteranganOverLimit}
                message={
                  errors?.n_1_1_terpenuhi_ket?.message ||
                  (isKeteranganOverLimit
                    ? "Karakter tidak boleh lebih dari 250."
                    : "")
                }
                ...
                rows="4"
                onChange={(e) =>
                  handleInputChange("n_1_1_terpenuhi_ket", e.target.value)
                }
              />
            }
            </Col>
