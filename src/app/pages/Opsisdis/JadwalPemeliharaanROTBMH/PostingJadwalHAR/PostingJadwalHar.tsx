...
/** SERVICE */
import PostingJadwalHarDetailPageCopy from "./PostingJadwalHarDetailPageCopy";
      ...
      dataTableValue.push({
        ...
        action: (
          <div className="d-flex gap-2">
            ...
            {roleActions?.posting && canPosting(item) && (
              <button
        ...
        <TableData
          ...
          filterParams={{
            ...
            datum_before: moment()
              ...
              .format("YYYY-MM-DD"),
            status_pekerjaan_in:
              "DRAFT,USULAN PEKERJAAN,RENCANA JADWAL PEKERJAAN,USULAN PEKERJAAN (APPROVED UID),USULAN PEKERJAAN (REVISI) , PELAKSANAAN, SUDAH DILAKSANAKAN, SUDAH MANUVER, BATAL DILAKSANAKAN, RELEASE PEKERJAAN",
