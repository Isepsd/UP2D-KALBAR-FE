...
import UpdateJadwalHarDetailFormPage from "./UpdateJadwalHarDetailFormPage"
...
export default function UpdateJadwalHarDetailPage({ filterParams }: any) {
