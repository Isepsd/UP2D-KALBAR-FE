...
import { OPSISDIS_USULAN_JADWALHAR_COLUMN_JQX } from "@app/configs/react-table/opsisdis.column.config";
...
import UsulanJadwalHarDetailPage from './UsulanJadwalHarDetailPage'
...
export default function UsulanJadwalHarJQ() {
  ...
  const handleFilterChange = (newFilterValues: any) => {
    ...
    setIsSubmitting(true); // Reset flag after data is updated
  };
  ...
  return (
    <>
      ...
      <CardWidget title="FILTER">
        <UsulanFilter onFilterChange={handleFilterChange} />
      </CardWidget>
          ...
          <Col md={12}>
            <JqxTabs theme="light">
              <ul style={{ marginLeft: 10 }} key="1">
                <li>
                  <i className="fa-solid fa-server"></i> Entri Jadwal Pemeliharaan
                </li>
              </ul>
              <div key="2">
                <TableDataJqxGridNewButtonjdlpemeliharaan
                  ...
                  dataFieldsColsConfig={OPSISDIS_USULAN_JADWALHAR_COLUMN_JQX()}
      ...
      <Row>
        <Col md={12} className="mb-4">
          <UsulanJadwalHarDetailPage filterParams={{ trans_jadwal_har_id: detailsHar, id_penyulang: penyulangID }} />
        </Col>
      </Row>
