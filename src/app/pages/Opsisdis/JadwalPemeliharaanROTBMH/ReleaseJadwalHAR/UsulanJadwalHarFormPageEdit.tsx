...
function UsulanJadwalHarFormPage({
        ...
        const fetchMasaSiaga = async () => {
          try {
            const res: any = await getAllByPath(
              API_PATH().master.siopak.masa_siaga,
              { page: 1, limit: 100 },
              source.token
            );
  ...
  const onSubmitForm = (data: IJadwalPemerliharaan) => {
    ...
    // const approvelApd =
    //   buttonClicked === "tidak_setuju" ? 2 : 1;
    ...
    const filledData = {
      ...
      // status_pekerjaan: statusPekerjaan || data.status_pekerjaan,
      status_pekerjaan: buttonClicked === "tidak_setuju"
        ? "BATAL DILAKSANAKAN"
        :  data.status_pekerjaan,
      approvel_area: data.approvel_area,
      // approvel_apd: approvelApd || data.approvel_apd,
      approvel_apd: buttonClicked === "tidak_setuju" ? 2 : data.approvel_apd,
                ...
                <Form.Group as={Row} className="mb-2">
                  ...
                  <Col md={8}>
                    <SelectAsyncDynamicNewOnchange
                      ...
                      setValue={setValue}
                      isDisabled={!watchGarduInduk || isReadOnly}
                      watchParent={watchGarduInduk}
                ...
                <Form.Group as={Row} className="mb-2">
                  ...
                  <Col md={8}>
                    <SelectAsyncDynamicNewOnchangeGardu
                      ...
                      setValue={setValue}
                      isDisabled={!watchPenyulang || isReadOnly}
