...
import PostingJadwalHarDetailFormPage from "./KepencetJadwalHarDetailFormPage"
...
export default function PostingJadwalHarDetailPage({ filterParams }: any) {
    ...
    useEffect(() => {
        let roleAccess = ROLE_ACCESS("posting-jadwal-har");
        const roleAct = {
    ...
    return (
        <>
            {roleActions.view && roleActions.create && roleActions.updatedok && roleActions.updategar && roleActions.delete && roleActions.upload ? (
                <>
                    <JqxTabs theme='light'>
                    ...
                    <ModalFormWO modalProps={{ ...modalUpload, setShow: handleClose }}>
                        <PostingJadwalHarDetailFormPage
