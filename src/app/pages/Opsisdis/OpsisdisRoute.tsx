...
const JadwalPemeliharaanNewRoute = React.lazy(() => import("@app/pages/Opsisdis/JadwalPemeliharaanROTBMH/JadwalPemeliharaanNewRoute"))
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="jadwal-pemeliharaan/*" element={<React.Suspense fallback={<TopBarLoader />}><JadwalPemeliharaanNewRoute /></React.Suspense>} />
