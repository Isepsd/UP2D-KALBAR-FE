...
import { OPTIONS_OBJECT_PEMELIHARAAN, OPTIONS_PRIORITAS, OPTIONS_SIFAT_PEMELIHARAAN, OPTIONS_KONDISI_PEKERJAAN } from '@app/configs/select-options.config';

import { API_PATH } from '@app/services/_path.service';

function ApproveBagianForm() {
      ...
      <Row>
        <Col md={12} className='mb-4 position-static'>
          <Card style={{borderColor: 'var(--success)'}}>
            <Card.Header className='bg-success font-weight-light text-white'>FORM USULAN PEMELIHARAAN UP3/ULP</Card.Header>
            <Card.Body>
              <FormData
                setError={setError}
                setValue={setValue}
                    ...
                    <Card.Body>
                      <Row>
                        ...
                        <Col md={6}>
                          ...
                          <Form.Group className='mb-3'>
                            <Form.Label>Wilayah Padam</Form.Label>
                            <Form.Control
                              {...register('wilayah_padam')} as='textarea'
                              isInvalid={errors.wilayah_padam}
                            />
                            <Form.Control.Feedback type='invalid'>{errors?.wilayah_padam?.message}</Form.Control.Feedback>
                          </Form.Group>
                          <Form.Group className='mb-3'>
                      ...
                      <Row>
                        <Col md={6}>
                          ...
                          <Form.Group className='mb-3'>
                            <Form.Label>Jumlah Pelanggan Padam<RequiredInfo /></Form.Label>
                            <InputGroup className="mb-3">
                              <Form.Control {...register('jlh_pelanggan_padam')} isInvalid={errors.jlh_pelanggan_padam} type='number' aria-describedby="availibility-addon2" />
                              <InputGroup.Text id="availibility-addon2">Plg</InputGroup.Text>
                            </InputGroup>
                            <Form.Control.Feedback type='invalid'>{errors?.jlh_pelanggan_padam?.message}</Form.Control.Feedback>
                          </Form.Group>
                          <Form.Group className='mb-3'>
                            <Form.Label>Beban Padam<RequiredInfo /></Form.Label>
                            <InputGroup className="mb-3">
                              <Form.Control {...register('beban_padam')} isInvalid={errors.beban_padam} type='number' aria-describedby="availibility-addon2" />
                              <InputGroup.Text id="availibility-addon2">Plg</InputGroup.Text>
                            </InputGroup>
                    ...
                    <Card.Body>
                      <Row>
                        ...
                        <Col md={6}>
                          <Form.Group className='mb-3'>
                            <Form.Label>
                            Penanggung Jawab UP3/ULP <RequiredInfo />
                            </Form.Label>
                            <SelectAsyncDynamic
                          ...
                          <Form.Group className='mb-3'>
                            <Form.Label>
                              Pengawas Pekerjaan UP3/ULP <RequiredInfo />
                            </Form.Label>
                            <SelectAsyncDynamic
                          ...
                          <Form.Group className='mb-3'>
                            <Form.Label>
                              Pengawas K3 UP3/ULP <RequiredInfo />
                            </Form.Label>
                            <SelectAsyncDynamic
...
export default ApproveBagianForm