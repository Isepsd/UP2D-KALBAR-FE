...
export default function AproveSpvOpsisFormApproveJQ({isAlreadyApprove,id_spv_opsis, handleClose, isAlreadyPelaksanaan }: any) {
  ...
  return (
   ...
   {isAlreadyApprove === 'Di Setujui' ? (
        <Alert variant="danger" className="text-center mb-4">
          <p>Data Sudah Di Approve Spv Opsis</p>
        </Alert>
      ) : (
