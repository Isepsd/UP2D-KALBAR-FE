...
/** CONFIG */
import { SCADATEL_WO_APPROVE } from "@app/configs/react-table/fasop/scadatel-column-drafting";
...
const { currentUser } = useSelector((state: any) => state.auth);
 ...
 const [detailAprove,setdetailApprove] = useState<any>();
  ...
  const [columns, setColumns] = useState<any>(SCADATEL_WO_APPROVE());
...
const [filterValues] = useState<any>({
 ...
 const handleApprove = (item: any) => {
  ...
  setdetailAlreadyApprove(item?.approve_spv_opsis);
    ...
    {modalApprove.show && (
      <ModalFormWO modalProps={{ ...modalApprove, setShow: handleClose }}>
        <AproveSpvOpsisFormApproveJQ 
         ...
         isAlreadyApprove={detailAlreadyAprove} 
