...
import PelaksanaanWoDetailForm from "./PelaksanaanWoDetailForm"
...
export default function PelaksanaanWoDetailPage({st_selesai_wo,st_mulai_wo, filterParams }: any) {
...
const handleClose = () => {
  ...
  window.history.replaceState({}, '', newUrl);
    ...
    return (
      ...
      <PelaksanaanWoDetailForm 
      handleClose={handleClose} 
      st_mulai_wo={st_mulai_wo} 
      st_selesai_wo={st_selesai_wo} 
      filterParams= {id_modules} 
