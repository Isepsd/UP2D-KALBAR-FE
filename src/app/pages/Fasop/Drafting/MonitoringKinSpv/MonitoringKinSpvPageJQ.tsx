...
/** CONFIG */
import { SCADATEL_MONITORING_WO_SPV_GRID } from "@app/configs/react-table/fasop/scadatel-column-drafting";
...
// import AproveSpvBidangDetailPageJQ from './MonitoringKinSpvDetailPageJQ';
...
export default function MonitoringKinSpvPageJQ() {
...
const handleFilterChange = (newFilterValues: any) => {
  ...
  return (
    <>
      <CardWidget title='SCADATEL - Drafting - Kinerja Scada SPV'>
        <Row className='gx-1'>
          {renderBoxKomulatif}
        </Row>
      </CardWidget>
        ...
        <div style={{ margin: '20px' }}>
          <JqxTabs theme={"light"}>
            <ul style={{ marginLeft: 10 }}>
              <li><i className="fa-solid fa-server"></i> Kinerja Scada SPV</li>
            </ul>
            <div>
              <TableDataJqxGridNewArray
                path={API_PATH().fasop.drafting.monitoring_wo_kinerja_spv}
                filterParams={{...filterValues}}  // Filter untuk posting_wo 1, 3, dan 4
                dataFieldsColsConfig={SCADATEL_MONITORING_WO_SPV_GRID()}
                primaryKey={'id'}
