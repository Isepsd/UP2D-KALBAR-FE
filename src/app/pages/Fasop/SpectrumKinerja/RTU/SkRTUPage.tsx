...
/** CONFIG */
import {
  KIN_RTU_HARI_COLUMNS,
  KIN_RTU_BULAN_COLUMNS,
...
const tabOptions = [
  {
    label: 'Harian',
    key: 'harian',
    pathService: API_PATH().fasop.kinerja.rtu_hari,
    primaryKey: 'id_kin_rtu_harian',
    column: KIN_RTU_HARI_COLUMNS(),
  },
  {
    label: 'Bulanan',
    key: 'bulanan',
    pathService: API_PATH().fasop.kinerja.rtu_bulan,
    primaryKey: 'id_kin_rtu_bulan',
    column: KIN_RTU_BULAN_COLUMNS(),
  },
];

export default function SkRTUPage() {
  ...
  return (
    <>
      ...
      >
        <KinerjaFilter type={tabActive} jenisPointType='RTU' keywordName='RTU' keywordField='path3text' />
      </TableDataListAction>
