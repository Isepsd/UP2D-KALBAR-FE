...
/** CONFIG */
import { ANALOG_HARI_COLUMNS, ANALOG_BULAN_COLUMNS } from '@app/configs/react-table/fasop/spectrum-kinerja.column'
...
const tabOptions = [
  { label: 'Harian', key: 'harian', pathService: API_PATH().fasop.kinerja.analog_hari, primaryKey: 'id_kin_analog_harian', column: ANALOG_HARI_COLUMNS() },
  { label: 'Bulanan', key: 'bulanan', pathService: API_PATH().fasop.kinerja.analog_bulan, primaryKey: 'id_kin_analog_bulan', column: ANALOG_BULAN_COLUMNS() },
]

export default function SkAnalogPage() {
  ...
  return (
    <>
      ...
      <TableDataListAction add={false} columns={columns} setColumns={setColumns}>
        <KinerjaFilter type={tabActive} jenisPointType='ANALOG' />
      </TableDataListAction> 
