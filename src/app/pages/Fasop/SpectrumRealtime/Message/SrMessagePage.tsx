...
/** CONFIG */
import { MESSAGE_COLUMNS } from '@app/configs/react-table/fasop/spectrum-realtime.column'
...
export default function SrMessagePage() {
  /** DATA RESP */
  const [dataRows, setDataRows] = useState<any>([]);
  const [columns, setColumns] = useState<any>(MESSAGE_COLUMNS());
