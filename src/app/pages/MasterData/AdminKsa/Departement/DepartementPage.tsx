...
import { MASTER_DATA_DEPARTEMENT } from '@app/configs/react-table/master-data-adminksa.columns.config';
...
export default function PerusahaanPage() {
  ...
  const [columns, setColumns] = useState<any>(MASTER_DATA_DEPARTEMENT());
  ...
  useEffect(() => {
    ...
    let roleAccess = ROLE_ACCESS("department")
    const roleAct = {
