...
import { MASTER_DATA_PERUSAHAAN } from '@app/configs/react-table/master-data-adminksa.columns.config';
...
export default function PerusahaanPage() {
  ...
  const [columns, setColumns] = useState<any>(MASTER_DATA_PERUSAHAAN());
