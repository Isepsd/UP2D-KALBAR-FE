...
import { SUBSISTEM } from '@app/configs/react-table/master-jaringan.columns.config';
...
export default function SubsistemPage() {
  ...
  const [columns, setColumns] = useState<any>(SUBSISTEM());
