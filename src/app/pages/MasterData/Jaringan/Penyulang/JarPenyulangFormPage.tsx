...
export default function JarPenyulangForm() {
  ...
  const validationSchema: any = Yup.object().shape({
    ...
    sub_sistem: Yup.string().typeError('Belum pilih Subsistem').required('Belum pilih Subsistem'),
  ...
  const onSubmitForm = (data: IJaringanPenyulang) => {
    ...
    if (data?.id_gardu_induk) {
      id_parent = data?.id_gardu_induk
    }
        ...
        <Form noValidate onSubmit={handleSubmit(onSubmitForm)}>
          <Row className='mb-3'>
            ...
            <Col md="7">
              ...
              <Form.Group className='mt-3' controlId='fungsi_lokasi'>
