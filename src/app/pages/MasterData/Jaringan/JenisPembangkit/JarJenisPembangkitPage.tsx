...
import { MASTER_DATA_JENIS_PEMBANGKIT } from '@app/configs/react-table/master-jaringan.columns.config';
import { useSelector } from 'react-redux';
import { ROLE_ACCESS, ROLE_ACTION } from '@app/helper/auth.helper';

export default function JarJenisPembangkitPage() {
  const { closeModal } = useSelector( (state: any) => state.ui );

  /** DATA RESP */
  const [dataRows, setDataRows] = useState<any>([]);
  const [columns, setColumns] = useState<any>(MASTER_DATA_JENIS_PEMBANGKIT());
