  ...
  const handleRespDataApi = (data: any) => {
    ...
    data?.forEach((item: IJaringan, index: number) => {
      dataTableValue.push({
        ...
        lat: item?.lat,
        lon: item?.lon,
        id_upt: item?.upt?.nama_lokasi,
        id_ultg: item?.ultg?.nama_lokasi,
  ...
  return (
    <>
      ...
      <TableData
        ...
        deleteConfirmation
        filterParams={{ id_ref_jenis_lokasi_in: `${JENIS_LOKASI().uiw},${JENIS_LOKASI().up3},${JENIS_LOKASI().ulp}, ${JENIS_LOKASI().up2d}, ${JENIS_LOKASI().up3b}, ${JENIS_LOKASI().up2b}, ${JENIS_LOKASI().ultg}, ${JENIS_LOKASI().upt}`, sort_by: '-tgl_update,id_ref_lokasi' }}
      ></TableData>
    </>
  );
}
