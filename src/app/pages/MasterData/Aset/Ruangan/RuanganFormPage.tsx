...
import {IAsetRuangan, AsetRuanganField} from '@app/interface/aset-ruangan.interface';
import RequiredInfo from '@app/components/Info/RequiredInfo';
import { API_PATH } from '@app/services/_path.service';

export default function RuanganFormPage() {
  const { id } = useParams();
  ...
  const onSubmitForm = (data: IAsetRuangan) => {
    if(id){
