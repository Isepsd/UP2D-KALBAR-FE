...
import {IAsetStatus, AsetStatusField} from '@app/interface/aset-status.interface';
...
export default function KondisiFormPage() {
  ...
  const onSubmitForm = (data: IAsetStatus) => {
    if(id){
  ...
  return (
    <>
      <FormData
        ...
        path={API_PATH().master.aset.ref_aset_status}
        customLabel='state'
