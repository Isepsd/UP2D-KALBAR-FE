...
import {IAsetKondisi, AsetKondisiField} from '@app/interface/aset-kondisi.interface';
...
export default function KondisiFormPage() {
  ...
  const onSubmitForm = (data: IAsetKondisi) => {
    if(id){
  ...
  return (
    <>
      <FormData
        ...
        path={API_PATH().master.aset.ref_aset_kondisi}
        customLabel='state'
