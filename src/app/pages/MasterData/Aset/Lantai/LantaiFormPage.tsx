...
import {IAsetLantai, AsetLantaiField} from '@app/interface/aset-lantai.interface';
import RequiredInfo from '@app/components/Info/RequiredInfo';
import { API_PATH } from '@app/services/_path.service';

export default function LantaiFormPage() {
  const { id } = useParams();
  ...
  const onSubmitForm = (data: IAsetLantai) => {
    if(id){
  ...
  return (
    <>
      <FormData
        ...
        path={API_PATH().master.aset.ref_aset_lantai}
        customLabel='state'
