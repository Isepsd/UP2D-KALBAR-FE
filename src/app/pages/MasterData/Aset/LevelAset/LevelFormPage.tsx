...
import {IAsetLevel, AsetLevelField} from '@app/interface/aset-level.interface';
import RequiredInfo from '@app/components/Info/RequiredInfo';
import { API_PATH } from '@app/services/_path.service';

export default function KondisiFormPage() {
  const { id } = useParams();
  ...
  const onSubmitForm = (data: IAsetLevel) => {
    if(id){
  ...
  return (
    <>
      <FormData
        ...
        fields={AsetLevelField}
        path={API_PATH().master.aset.ref_aset_level}
        customLabel='state'
