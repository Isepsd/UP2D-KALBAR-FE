...
import {IAsetManufaktur, AsetManufakturField} from '@app/interface/aset-manufaktur.interface';
import RequiredInfo from '@app/components/Info/RequiredInfo';
import { API_PATH } from '@app/services/_path.service';

export default function ManuFakturFormPage() {
  const { id } = useParams();
  ...
  const onSubmitForm = (data: IAsetManufaktur) => {
    if(id){
  ...
  return (
    <>
      <FormData
        ...
        path={API_PATH().master.aset.ref_aset_manufaktur}
        customLabel='state'
