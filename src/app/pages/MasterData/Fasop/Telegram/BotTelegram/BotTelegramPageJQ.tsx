...
/** CONFIG */
import { TELEGRAM_BOT_COLUMNS_JQ, } from '@app/configs/react-table/master-fasop.columns.config';
/** COMPONENTS */
            ...
            {roleActions.create && roleActions.update && roleActions.delete &&
                ...
                <ul style={{ marginLeft: 10 }} key="1">
                    ...
                    <TableDataJqxGridNew
                        ...
                        filterParams={{}}
                        dataFieldsColsConfig={TELEGRAM_BOT_COLUMNS_JQ()}
                        primaryKey={'id_tel_bot'}
