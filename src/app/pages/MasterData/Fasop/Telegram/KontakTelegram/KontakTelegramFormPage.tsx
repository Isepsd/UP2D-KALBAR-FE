...
import { IFasopTelegramKontak, FasopTelegramKontakField } from '@app/interface/master-data/fasop-telegram-kontak.interface';

import FormData from '@app/modules/Form/FormData';
import ButtonCancel from '@app/components/Button/ButtonCancel';
import { API_PATH } from '@app/services/_path.service';

export default function KontakTelegramFormPage() {
    ...
    const onSubmitForm = (data: IFasopTelegramKontak) => {
        setDataParams(data);
    };
    ...
    return (
        <>
            <FormData
                ...
                fields={FasopTelegramKontakField}
