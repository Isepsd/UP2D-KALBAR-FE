...
import { PERTANYAAN_QRC_COLUMNS } from '@app/configs/react-table/master-working-permit.column.config';
...
export default function WpPertanyaanQRCPage() {
  ...
  const [columns, setColumns] = useState<any>(PERTANYAAN_QRC_COLUMNS());
