...
/** PAGE */
const KinerjaScadaPage = React.lazy(() => import("@app/pages/Dashboard/KinerjaScada/KinerjaScadaPageBANGKA"))
...
export default function DashboardRoute() {
  return (
    <>
      <Routes>
        <Route path="kinerja-scada" element={<React.Suspense fallback={<TopBarLoader />}><KinerjaScadaPage /></React.Suspense>} />
