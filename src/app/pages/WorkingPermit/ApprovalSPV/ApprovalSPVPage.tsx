...
export default function ApprovalSPVPage() {
  ...
  useEffect(() => {
    let roleAccess = ROLE_ACCESS("approval-wp-spv")
    const roleAct = {
  ...
  return (
    <>
      ...
      <TableData
        ...
        trigger={triggers}
        approvalAlias={2}
        filterParams={{sort_by:'-id_wp_online',status_persetujuan:'1',id_user_spv: currentUser?.id_user}}
        deleteConfirmation
      />
