...
export default function ApprovalOpsisPage() {
  ...
  useEffect(() => {
    let roleAccess = ROLE_ACCESS("approval-opsis")
    const roleAct = {
  ...
  return (
    <>
      ...
      <TableData
        ...
        trigger={triggers}
        approvalAlias={4}
        filterParams={{ sort_by: '-id_wp_online', status_persetujuan: '3', manuver: true,id_user_opsis:currentUser?.id_user }}
        deleteConfirmation
      />
