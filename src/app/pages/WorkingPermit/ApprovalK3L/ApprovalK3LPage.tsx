...
export default function ApprovalK3LPage() {
  ...
  useEffect(() => {
    let roleAccess = ROLE_ACCESS("approval-wp-k3l")
    const roleAct = {
  ...
  return (
    <>
      ...
      <TableData
        ...
        trigger={triggers}
        approvalAlias={5}
        filterParams={{ sort_by: '-id_wp_online', status_persetujuan: '3,4',id_pengawas_k3:currentUser?.id_user }}
        deleteConfirmation
      />
