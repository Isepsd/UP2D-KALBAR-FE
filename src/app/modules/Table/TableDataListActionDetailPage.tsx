...
function TableDataListActionDetailPage({
  children,
  ...
  const { generateData } = useSelector((state: any) => state.app);
 ...
 const dispatchNotification = (msg: string = '', type: string = '') => {
  ...
  const getAllDataExportTemplate = async (export_type: any) => {
    setLoaderDownload(true); // Set loading to true before starting export
    ...
    try {
      ...
      setLoaderDownload(false); // Set loading to false once export is finished or if there's an error
    }
  };
  return (
    <>
                  ...
                  <Dropdown.Menu>
                    {exportOptions
                      ...
                      .map((d: any) => (
                        <Dropdown.Item
                          key={nanoid()}
                          onClick={() => getAllDataExportTemplate(d.type)}
                        >
                          {d.label}
                        </Dropdown.Item>
                      ))}
...
export default React.memo(TableDataListActionDetailPage);
