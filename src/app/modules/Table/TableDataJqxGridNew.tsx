...
interface ITableDataJqxGridNew {
  ...
  exporttemplatebtn?: any; // memunculkan tombol export
  ...
  filterColumnMapping?: Record<string, string>;
}
        ...
        for (let i = 0; i < filterGroups.length; i++) {
          ...
          for (let j = 0; j < filters.length; j++) {
            ...
            if (filterGroup.filtercolumn) {
              ...
              //costum filterable
              const columnName = filterColumnMapping[filterGroup.filtercolumn] || filterGroup.filtercolumn;
              queryParam = {
                ...queryParam,
