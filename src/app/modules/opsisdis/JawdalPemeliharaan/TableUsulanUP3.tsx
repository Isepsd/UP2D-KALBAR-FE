...
/** CONFIGS */
import { USULANUP3_COLUMN } from '@app/configs/react-table/opsisdis/jadwal-pemeliharaan.column'
...
function TableUsulanUP3() {
  // const navigate = useNavigate();

  /** DATA RESP */
  const [dataRows, setDataRows] = useState<any>([]);
  const [columns, setColumns] = useState<any>(USULANUP3_COLUMN());
