    ...
    try {
      ...
      getAllByPath(pathService, params, source.token)
        .then((response: any) => {
          ...
          data = orderBy(data, ['label'], ['asc']); // Urutkan berdasarkan label secara alfabetis
      ...
      <Controller
        ...
        render={({ field: { onChange: internalOnChange, value, ref } }) => (
          <AsyncSelect
            ...
            defaultOptions={orderBy(selectOptions, ['label'], ['asc'])} // Pastikan opsi default juga diurutkan
            styles={styles}
...
interface ISelectAsyncDynamic {
  ...
  onChange?: (value: any) => void;  // New onChange prop
}
