                      ...
                      {columnFilters && !column.disableFilters && column.accessor && (
                        ...
                        >
                          ...
                          {column.id === 'butuh_padam' ? (
                            ...
                            <input
                              type={column.id.includes('datum') || column.id.includes('tanggal') || column.id.includes('periode') ? 'date' : 'text'}
                              placeholder={
                                column.id.includes('datum') || column.id.includes('tanggal') || column.id.includes('periode')
                                  ? 'Pilih tanggal'
                                  : 'Cari'
                              }
                              value={filterValues[column.id] || ''}
                ...
                return (
                  <tr {...row.getRowProps()} key={`tbody.tr${i}`}>
                    {row.cells.map((cell: any, indexTd: any) => {
                      ...
                      const approvel_uid = row.original.approvel_uid;
