  ...
  const getColumnStyle = (column:any) => {
    if (column.pinned) {
      return {
        ...
        left: 0,
        zIndex: 10,
        backgroundColor: 'white', // Tambahkan latar belakang agar kolom tetap terlihat
      };
    }
    return {};
  };
      ...
      <tr {...row.getRowProps()} key={`tbody.tr${i}`}>
       ...
       // Conditional style logic for background color
          ...
          if (approvel_area === 1 && approvel_apd === 0) {
            backgroundColor = 'yellow'; // Soft yellow (but not too pastel) for approvel_area = 1 and approvel_apd = 0
          ...
          return (
            <td
              ...
              style={{
                ...
                backgroundColor, // Apply the conditional background color here
              }}
            >
              {cell.render('Cell')}
            </td>
