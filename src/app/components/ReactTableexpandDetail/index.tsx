...
import RekapPadamPageNewwDetail from '@app/pages/Opsisdis/EntriGangguanPadam/RekapPadam/RekapPadamPageNewwDetail';
...
{RowExpand.includes(row.original.id) && (
  <tr>
    <td colSpan={row.cells.length + 1}>
      ...
      >
        <RekapPadamPageNewwDetail id={row.original.id} />
      </div>
    </td>
  </tr>
)}
