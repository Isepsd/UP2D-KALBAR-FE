...
function ModalTrafoGI({
  ...
  const [columns] = useState<any>(TRAFO_GI());
  ...
  useEffect(() => {
    setModal({ ...modalProps });
    if(modalProps?.show && idPenyulang) getAllData()
    ...
    <>
      ...
      <Modal keyboard={false} backdrop='static' scrollable centered show={modal.show} onHide={modalDecline} size='xl'>
        <Modal.Header closeButton>
          <Modal.Title className='w-100'>Daftar Trafo</Modal.Title>
